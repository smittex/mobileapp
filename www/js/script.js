var app = {
            ...
            switch (app.dal.db.version) {
                case '':
                    ...
                    $(document).one('db:update', function (event) {
                        ...
                        console.error(event.data.item(0));
                    });
                    ...
                    for (var i = 0; i < lines.length; i++)    {
                        console.error('about to execute: '+lines[i]);
    ...
    assessment: {
        ...
        question_answered: function () {
            ...
            console.error('question_id:' + question_id);
            console.error('answer_id:' + answer_id);
            try {
        ...
        getQuestion: function () {
            ...
            $(document).one('get:content', function (event) {
                try {
                    ...
                    console.error('ids:' + ans_ids);
                    console.error('texts:' + texts);
                    console.error('node_types:' + node_types);
                    console.error('node_ids:' + node_ids);
    ...
    rndrCont: function (scr, obj) {
        console.error('in rndrCont;scr:' + scr + ';obj:' + obj);
        ...
        switch (scr) {
            case 'question-container':
                ...
                $(document).one('question:ready', function (event) {
                    ...
                    console.error('in question container');
                    console.error(question);
                    var qtn_html = tmpl(question);
                    console.error(qtn_html);
            ...
            case 'product-page':
                ...
                $(document).one('get:content', function (event) {
                    console.error('creating product');
                    try {
                        var product = {
